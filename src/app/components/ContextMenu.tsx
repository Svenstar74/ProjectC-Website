...
export const ContextMenu: FC<Props> = ({ show, position, menuItems, clickedItemId = '', onClose }) => {    
  ...
  return (
    <div>
      ...
      <NewNodeDialog open={showNewNodeDialog} onClose={() => setShowNewNodeDialog(false)} position={position} />
      ...
      <Menu open={show} anchorReference="anchorPosition" anchorPosition={{ top: position.y, left: position.x}} onClose={onClose}>

            {menuItems.includes('addNode') && <MenuItem onClick={() => {setShowNewNodeDialog(true); onClose()}}>
              <ListItemIcon>
                <AddIcon />
              </ListItemIcon>
            ...
            {menuItems.includes('deleteNode') && <MenuItem onClick={() => {setShowDelNodeDialog(true); onClose()}}>
              <ListItemIcon>
                <DeleteIcon />
              </ListItemIcon>
            ...
            {menuItems.includes('addEdge') && <MenuItem onClick={() => {setShowNewEdgeDialog(true); onClose()}}>
              <ListItemIcon>
                <NorthEastIcon />
              </ListItemIcon>
            ...
            {menuItems.includes('deleteEdge') && <MenuItem onClick={() => {setShowDelEdgeDialog(true); onClose()}}>
              <ListItemIcon>
                <DeleteIcon />
              </ListItemIcon>

...
function NewNodeDialog({ open, onClose, position }: Props) {
  ...
  const submitForm = async () => {
    ...
    const result = await apiClient.addClimateConceptNode(stringRepresentation, nodePosition.x, nodePosition.y);
